...
;
const metadata = {
    title: "Pawan Girade - Frontend Developer Portfolio",
    description: "Frontend Developer specializing in React, Node.js, AWS Lambda, and GraphQL. Explore my projects and experience.",
    generator: "v0.app",
    icons: {
        icon: [
            {
